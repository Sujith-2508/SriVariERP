...
async function main() {
    try {
        ...
        console.log(`Listing all files (including shared)...`);
        const response = await fetch(`https://www.googleapis.com/drive/v3/files?pageSize=100&fields=files(id,name,mimeType,modifiedTime,owners,shared)&orderBy=modifiedTime desc`, {
