    ...
    if (!window.electron?.whatsapp) {
        return (
            <div className="bg-red-50 border border-red-100 rounded-xl p-4 text-sm text-red-600">
                WhatsApp integration is only available in the Desktop application.
            </div>
        );
    }
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="flex gap-3">
                        {status === 'READY' ? (
                            ...
                            <button
                                disabled
                                className="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-400 rounded-lg text-sm font-bold cursor-not-allowed border border-slate-200"
                            >
                                <RefreshCw size={16} />
                                Re-sync Connection
                            </button>
